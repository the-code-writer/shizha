...
const data: DataType[] = [
  {
    ...
    imgSrc: '/images/logos/cotton.png' // Update with appropriate image source
  },
  {
...
const ActiveProjectsCotton = () => {
  return (
    <Card>
      <CardHeader
        title='Cotton Harvest for 2024 by Province'
...
export default ActiveProjectsCotton
