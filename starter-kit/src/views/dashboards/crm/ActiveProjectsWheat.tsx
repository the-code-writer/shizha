...
const data: DataType[] = [
  {
    ...
    imgSrc: '/images/logos/wheat.png' // Update with appropriate image source
  },
  {
...
const ActiveProjectsWheat = () => {
  return (
    <Card>
      <CardHeader
        title='Wheat Production for 2024 by Province'
...
export default ActiveProjectsWheat
