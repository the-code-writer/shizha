...
const VerticalMenuOG = ({ dictionary, scrollMenu }: Props) => {
  // Hooks
    ...
    >
      ...
      >
        ...
        >
          ...
          <MenuItem href={`/${locale}/dashboards/ecommerce`}>{dictionary['navigation'].eCommerce}zzz</MenuItem>
